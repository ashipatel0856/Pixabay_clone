...
<button onClick ={() => fetchImageByCategory("Flowers")} type="button" className="btn btn-outline-danger mx-3">Flowers</button>
<button onClick ={() => fetchImageByCategory("animals")}  type="button" className="btn btn-outline-info mx-3">Animals</button>
<button onClick ={() => fetchImageByCategory("sports")} type="button" className="btn btn-outline-info mx-3">Sports</button>
<button onClick ={() => fetchImageByCategory("transportation")} type="button" className="btn btn-outline-light mx-3">tranports</button>
<button onClick ={() => fetchImageByCategory("travel")} type="button" className="btn btn-outline-warning mx-3">Travel</button>
